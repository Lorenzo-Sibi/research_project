...
PLOT_ALL_TYPE_LIST = ["statistics", "spectrum"]
...
def main(args):
    if args.command == "plot-all":
        if args.type == "statistics":
            visualize_data.statistics_all(args.input_directory, args.output_directory, 2)
        elif args.type == "spectrum":
            spectrum_all(args.input_directory, args.output_directory)
